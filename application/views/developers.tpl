	...
	<div class="content">	
		...
		<ul class="developers">
			...
			<li>
				...
				<p>
					<em>web</em>: <?php echo $dev['web']; ?><?php if (!empty($dev['twitter'])) echo ', follow on <a href="http://twitter.com/'.$dev['twitter'].'" rel="nofollow">twitter</a>'; if (!empty($dev['github'])) echo ', fork on <a href="http://github.com/'.$dev['github'].'" rel="nofollow">github</a>';?><br />
					<em>location</em>: <?php echo $dev['location']; ?></p>
			</li>
			<?php }?>
		</ul>
		...
		<ul class="developers alumni">
			...
			<li>
				...
				<p>
					<em>web</em>: <?php echo $dev['web']; ?><?php if (!empty($dev['twitter'])) echo ', follow on <a href="http://twitter.com/'.$dev['twitter'].'">twitter</a>'; if (!empty($dev['github'])) echo ', fork on <a href="http://github.com/'.$dev['github'].'">github</a>';?>
					<br /><em>location</em>: <?php echo $dev['location']; ?>
				</p>
			</li>
			<?php }?>
		</ul>
